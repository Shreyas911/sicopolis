...
def test_repo_ant40_b2_ss25ka_H():
	subprocess.run (['cp', '../runs/headers/sico_specs_repo_ant40_b2_ss25ka.h', '../src/sico_specs.h'])
...
def test_repo_ant64_b2_future09_ctrl_H():
	subprocess.run (['cp', '../runs/headers/sico_specs_repo_ant64_b2_future09_ctrl.h', '../src/sico_specs.h'])
...
def test_repo_grl16_bm5_ss25ka_H():	
	subprocess.run (['cp', '../runs/headers/sico_specs_repo_grl16_bm5_ss25ka.h', '../src/sico_specs.h'])
