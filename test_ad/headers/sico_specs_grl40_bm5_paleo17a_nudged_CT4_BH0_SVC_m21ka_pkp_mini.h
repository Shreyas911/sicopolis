...
#define TIME_INIT0 -21000.0d0
!                       Initial time of simulation (in a)

#define TIME_END0 -20980.0d0
...
#define ZS_PRESENT_FILE 'grl_bm5_40_topo.nc'
!                         Name of the file containing the present-day
!                         ice-surface topography

#define ZB_PRESENT_FILE 'grl_bm5_40_topo.nc'
!                         Name of the file containing the present-day
!                         ice-base topography
!                         (only for ANF_DAT==1;
!                          if 'none' or undefined, zb=zl will be assumed)

#define ZL_PRESENT_FILE 'grl_bm5_40_topo.nc'
!                         Name of the file containing the present-day
...
#define MASK_PRESENT_FILE 'grl_bm5_40_topo.nc'
!                         Name of the file containing the present-day
!                         ice-land-ocean mask
...
#define ANFDATNAME 'grl40_bm5_paleo17a_CT4_BH0_8point5CS_spinup_0ka0005.nc'
...
#define TARGET_TOPO_TAU0_FILE 'my_target_topo_tau_grl_spinup_deglac.dat'
...
#define TARGET_TOPO_PATH '/home/shreyas/update_to_develop_sicopolis/sicopolis_spinups/sico_out/grl40_bm5_spinup02_smooth_100a'
#define TARGET_TOPO_DAT_NAME 'grl40_bm5_spinup02_smooth_100a0001.nc'
...
#define TEMP_PRESENT_OFFSET -1.0d0
...
#define GRIP_TEMP_FILE 'NGRIP_GICC05modelext_Delta-Ts_max-eem-4.5_GISP2_GT4000Kobashi.dat'
...
#define PRECIP_MA_PRESENT_FILE 'grl_cc_40_prec.nc'
!                       Name of the file containing the present-day
...
#define PRECIP_ZS_REF_FILE 'grl_bm5_40_topo.nc'
...
!!! #define INITMIP_SMB_ANOM_FILE 'dsmb_40_ISMIP6_v2_EPSG3413.nc'
...
#define Q_GEO_FILE 'GHF_Greenland_Ver2.0_GridEPSG3413_40km.nc'
...
#define TIME_OUT0 (/ -21000.0d0, -11000.0d0, \
                     -9000.0d0 , -4000.0d0, -1000.0d0, -100.0d0, 0.0d0 /)
...
#define SURF_VXVY_COST
#define SURFVX_UNCERT_FIELD 'vx_uncert'
#define SURFVY_UNCERT_FIELD 'vy_uncert'
