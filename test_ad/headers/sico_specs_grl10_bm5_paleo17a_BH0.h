...
#define PRECIP_MA_PRESENT_FILE 'grl_cc_10_prec.nc'
!                       Name of the file containing the present-day
...
#define PRECIP_ZS_REF_FILE 'grl_bm5_10_topo.nc'
