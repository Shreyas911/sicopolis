...
def test_grl40_bm5_paleo17a_BH0_delta_tda_const_scalar_bsi():
	...
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0 -iv delta_tda_const -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_BM5_delta_tda_const_scalar_bsi():
	...
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_BM5 -iv delta_tda_const -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_FBM5_delta_tda_const_scalar_bsi():
	...
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_FBM5 -iv delta_tda_const -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_AC_delta_tda_const_scalar_bsi():
	...
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_AC -iv delta_tda_const -delta 5.e-2 -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_FAC_delta_tda_const_scalar_bsi():
	...
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_FAC -iv delta_tda_const -delta 5.e-2 -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)
...
def test_grl40_bm5_paleo17a_BH0_beta1_scalar_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0 -iv beta1 -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_BM5_beta1_scalar_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_BM5.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_BM5.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_BM5 -iv beta1 -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_AC_beta1_scalar_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_AC.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_AC.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_AC -iv beta1 -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_FBM5_beta1_scalar_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FBM5.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FBM5.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_FBM5 -iv beta1 -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_FAC_beta1_scalar_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FAC.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FAC.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_FAC -iv beta1 -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_beta2_scalar_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0 -iv beta2 -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_BM5_beta2_scalar_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_BM5.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_BM5.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_BM5 -iv beta2 -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_AC_beta2_scalar_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_AC.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_AC.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_AC -iv beta2 -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_FBM5_beta2_scalar_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FBM5.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FBM5.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_FBM5 -iv beta2 -delta 5.e-2 -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)
...
def test_grl40_bm5_paleo17a_BH0_Pmax_scalar_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0 -iv Pmax -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_BM5_Pmax_scalar_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_BM5.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_BM5.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_BM5 -iv Pmax -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_AC_Pmax_scalar_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_AC.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_AC.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_AC -iv Pmax -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_FBM5_Pmax_scalar_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FBM5.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FBM5.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_FBM5 -iv Pmax -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_FAC_Pmax_scalar_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FAC.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FAC.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_FAC -iv Pmax -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_mu_scalar_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0 -iv mu -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_BM5_mu_scalar_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_BM5.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_BM5.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_BM5 -iv mu -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_AC_mu_scalar_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_AC.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_AC.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_AC -iv mu -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_FBM5_mu_scalar_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FBM5.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FBM5.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_FBM5 -iv mu -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_FAC_mu_scalar_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FAC.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FAC.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_FAC -iv mu -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_s_stat_scalar_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0 -iv s_stat -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_BM5_s_stat_scalar_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_BM5.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_BM5.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_BM5 -iv s_stat -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_AC_s_stat_scalar_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_AC.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_AC.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_AC -iv s_stat -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_FBM5_s_stat_scalar_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FBM5.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FBM5.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_FBM5 -iv s_stat -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_FAC_s_stat_scalar_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FAC.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FAC.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_FAC -iv s_stat -jsf inputs.json -asi 0 -lbfs scalar', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_gamma_s_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0 -iv gamma_s -delta 1.e-4 -jsf inputs.json -asi 0', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_BM5_gamma_s_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_BM5.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_BM5.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_BM5 -iv gamma_s -delta 1.e-4 -jsf inputs.json -asi 0', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_FBM5_gamma_s_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FBM5.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FBM5.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_FBM5 -iv gamma_s -delta 1.e-4 -jsf inputs.json -asi 0', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_AC_gamma_s_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_AC.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_AC.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_AC -iv gamma_s -delta 1.e-4 -low 0.01 -jsf inputs.json -asi 0', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_FAC_gamma_s_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FAC.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FAC.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_FAC -iv gamma_s -delta 1.e-4 -low 0.01 -jsf inputs.json -asi 0', shell = True, check = True)
...
def test_grl40_bm5_paleo17a_CT4_BH0_FBM5_gamma_s_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_CT4_BH0_FBM5.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_CT4_BH0_FBM5.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_CT4_BH0_FBM5 -iv gamma_s -delta 1.e-4 -jsf inputs.json -asi 0', shell = True, check = True)
...
def test_grl40_bm5_paleo17a_BH0_H_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0 -delta 1.e-1 -jsf inputs.json -asi 0', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_BM5_H_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_BM5.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_BM5.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_BM5 -delta 1.e-4 -jsf inputs.json -asi 0', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_FBM5_H_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FBM5.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FBM5.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_FBM5 -delta 1.e-4 -low 0.01 -jsf inputs.json -asi 0', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_AC_H_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_AC.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_AC.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_AC -delta 1.e-4 -low 0.01 -jsf inputs.json -asi 0', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_FAC_H_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FAC.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FAC.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_FAC -delta 1.e-4 -low 0.01 -jsf inputs.json -asi 0', shell = True, check = True)
...
def test_grl40_bm5_paleo17a_CT4_BH0_FAC_H_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_CT4_BH0_FAC.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_CT4_BH0_FAC.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_CT4_BH0_FAC -delta 1.e-4 -low 0.01 -jsf inputs.json -asi 0', shell = True, check = True)
...
def test_grl40_bm5_paleo17a_BH0_AC_age_c_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_AC.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_AC.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_AC -iv age_c -dim 3 -z 40 -jsf inputs.json -asi 0', shell = True, check = True)

def test_grl40_bm5_paleo17a_BH0_FAC_age_c_bsi():
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FAC.h', '../headers'])
	subprocess.run (['cp', 'headers/sico_specs_grl40_bm5_paleo17a_BH0_FAC.h', '../src/sico_specs.h'])
	subprocess.run('python3 tapenade_config.py -head grl40_bm5_paleo17a_BH0_FAC -iv age_c -dim 3 -z 40 -jsf inputs.json -asi 0', shell = True, check = True)
