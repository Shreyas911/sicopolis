...
!         number of grid points --------
   ...
   errormsg = ' >>> sico_init: ' &
                 //'GRID==0 or 1 not allowed for the Tibet application!'
   call error(errormsg)
...
#if (GRID==0 || GRID==1)
errormsg = ' >>> sico_init: GRID==0 or 1 not allowed for this application!'
call error(errormsg)
#elif (GRID==2)
...
errormsg = ' >>> sico_init: GRID==0 or 1 not allowed for the Tibet application!'
call error(errormsg)
...
errormsg = ' >>> sico_init: ANF_DAT==1 not allowed for Tibet application!'
call error(errormsg)
