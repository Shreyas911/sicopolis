...
real(dp), parameter :: &
          ...
          zs_90_present = 3.85e+03_dp   ! Present elevation of the
                                        ! south pole [m]
real(dp), parameter :: &
...
real(dp), parameter :: &
          temp_s_min = -128.0_dp   ! Minimum ice-surface temperature 
...
ecc0 = 0.0_dp   ! on mean-annual south-polar insolation is negligible

!  ------ Mean annual insolation at the south pole
...
!  ------ Mean-annual surface temperature at the south pole
...
!  ------ Surface-temperature deviation at the south pole
...
errormsg = ' >>> boundary: SEA_LEVEL==2 not allowed for smars application!'
call error(errormsg)

#elif (SEA_LEVEL==3)

errormsg = ' >>> boundary: SEA_LEVEL==3 not allowed for smars application!'
call error(errormsg)
...
call borehole(zs, 0.0_dp, 0.0_dp, dxi, deta, 'grid', zs_90)
                             ! zs_90: elevation of the south pole
