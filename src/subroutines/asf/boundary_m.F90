...
gamma_t = -4.5e-03_dp   ! atmospheric lapse rate
...
as_perp = accum - runoff
   ...
   !hack for initial present-day conditions:
   !set as_perp to zero, hold bedrock fixed and let zs evolve freely (initial zs smoothing)
   !as_perp = 0.0_dp
