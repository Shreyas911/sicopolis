...
\hypersetup{
    ...
    pdftitle={SICOPOLIS V5.2 - Quick Start Manual},
...
Download the gzipped tar archive sicopolis\_v52.tgz from Zenodo
\\
(https://doi.org/10.5281/zenodo.3687337 !!! Should be changed !!!).

Unpack the archive: \verb+tar -x -v -z -f sicopolis_v52.tgz+

\item \textbf{Option 2: Using Git}

\hspace*{1.5em}\verb+git clone --depth 1 --branch v5.2 \+
\\[-1ex]
...
\\
\hspace*{1.5em}\verb+./get_input_files.sh+ (!!! Also for tarball? !!!)
% \end{small}
